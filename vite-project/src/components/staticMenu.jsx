...
const TopNav=()=>{
    ...
    return(
        ...
        <div className="whoAreWe" id="#whoAreWe">
            ...
            <figure>
                <img src="" alt="" />
                <legend>Soy un estudiante de Ingenieria en sistemas con animo de aprender nuevas herramientas. Listo para superar los retos
                    que presente la carrera. 

                </legend>
            </figure>
        </div>
        <div className="products" id="#producst">
            <h2>Productos</h2>
        </div>
